...
local movement = require 'mods/crispy-guacamole/entities/dog/movement'
...
function states:onEntityEnteredVisionRange(dog, entity)
	if entity:getTemplateName() == 'sheep' and (not dog:getExtraData().target or not dog:getExtraData().target:isValid()) then
