...
local function selectTile(tl, tr, bl, br, t, r, b, l)
    local caseValue = 0
    if b == "high_grass" and br == "high_grass" and bl == "high_grass" then
        caseValue = caseValue + 128
    end
    if l == "high_grass" and bl == "high_grass" and tl == "high_grass" then
        caseValue = caseValue + 32
    end
    if r == "high_grass" and br == "high_grass" and tr == "high_grass" then
        caseValue = caseValue + 4
    end
    if t == "high_grass" and tr == "high_grass" and tl == "high_grass" then
        caseValue = caseValue + 1
    end
    if tr == "high_grass" then
        caseValue = caseValue + 2
    end
    if tl == "high_grass" then
        caseValue = caseValue + 8
    end
    if br == "high_grass" then
        caseValue = caseValue + 16
    end
    if bl == "high_grass" then
