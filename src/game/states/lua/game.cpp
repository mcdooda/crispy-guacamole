...
int l_game_setGhostEntity(lua_State* L)
{
	...
	flat::lua::UniqueLuaReference<LUA_TFUNCTION> getGhostEntitiesPositions;
	getGhostEntitiesPositions.setIfNotNil(L, 2);
	...
	gameState.setGhostEntitiesPositions(std::move(getGhostEntitiesPositions));
